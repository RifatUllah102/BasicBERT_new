...
def main():
    ...
    #         # Reset Model
    #         model = load_pretrained_model(args)
    #         model, best_result = Train(args, logger, model, train_dataloader, processor, task_name, label_list, tokenizer, output_mode)

    #         # Test
    #         all_guids, eval_dataloader = load_test_data(args, logger, processor, task_name, label_list, tokenizer, output_mode)
    #         preds = evaluation(args, logger, model, eval_dataloader, all_guids, task_name, return_preds=True)
    ...
    #                 args, logger, processor, task_name, label_list, tokenizer, output_mode
    #             )
    #             evaluation(args, logger, model, eval_dataloader, all_guids, task_name)
    #     else:
    #         all_guids, eval_dataloader = load_test_data(
    #             args, logger, processor, task_name, label_list, tokenizer, output_mode
    #         )
